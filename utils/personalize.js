...
const PATTERN_RULES = [
  ...
  //    Q14: D(3)复盘全场 / B(1)回味某句话
  {
    ...
    strong: '你的大脑在社交中不会关机。第2题你被排除在聚会外——你没有只是生气，而是分析了谁叫的局、谁是主动谁是被动。第14题聚会结束后，你还在复盘全场：谁和谁之间有点微妙、你有没有说错什么。你在社交中不只接收对话内容——你还在读取关系之间的张力和信号。这套系统让你对人了如指掌，但代价是：你永远比同场的人多累一倍。',
    mild: '你比大多数人更早注意到社交中微妙的信号。一场聚会结束，你的大脑还在继续工作——回味那些对话、分析那些关系。这是一种天赋，也是一种别人看不出来的负担。'
  },
  ...
  //    Q12: A(0)一个人消化 / C(2)身体动起来          → 不找人倾诉
  {
    ...
    strong: '第5题和第12题——你处理情绪的入口和出口是同一种方式：一个人。晚上躺床上，大脑开始自动重播"如果当时…"的片段，身体跟着演。真正难过的时候也是一个人待着——灯关了，裹在被子里，不用解释。你觉得说出来之前的那些感受，别人很难真的接到。所以你先消化完了再出现。这套系统大部分时候很好用——但偶尔会卡住，消化不完的时候你也在装消化完了。',
  ...
  //    Q11: B(1)先试一小步 / C(2)直觉冲 / D(3)先问人
  {
    ...
    strong: '第10题和第11题暴露了你的出厂设置。看到"规则"和"应该"这两个词，你先过一遍自己的判断才决定要不要服从。面对不确定的机会，你更愿意信自己的直觉而不是纸面的利弊。规则在你这里是参考线。这套直觉在大多数时候是你的优势。但偶尔会让你跳过应该多看一眼的步骤。',
  ...
  //    Q9: B(1)反复复盘 / C(2)分析性接纳
  {
    ...
    strong: '你处理情绪事件的方式很特别：你不会让它"过去"——你会把它变成一道分析题。第5题你晚上躺床上不是在单纯难受，是在分析前因后果。第9题一段关系结束了，最让你卡住的是"结束的方式不清不楚"。没归档的东西没法归档——不清不楚的淡出比明确的告别难受一百倍。你想通了才能放下。这是你尊重发生过的事的方式。',
  ...
  //    或 Q4: D(3) + Q3: D(3)评估后决定
  {
    ...
    strong: '第4题和第13题，你在处理人际摩擦上有同一种风格。饮品不对——你端回去，笑着说"能帮我看看吗"，不吵不闹但要拿到你付钱买的东西。跟好朋友吵架——你先想清楚到底在吵什么，带着结论去，不是带着情绪去。你靠清晰来解决问题，不靠音量。这种坚定比任何嗓门都更有力量。',
...
const CONTRADICTION_RULES = [
  ...
  // 1. 社交分裂：独处刚需 vs 享受有深度的社交
  {
    ...
    body: '第6题你说一个人待一整天"太好了能不能再续一天"——你是认真的。但第14题聚会结束之后，你在回味某个人的某句话，你觉得那场局至少有一个值得的对话。95%的社交对你来说太淡了，不值得消耗能量。剩下的5%——那个有深度的对话、那个跟你同频率的人——能给你能量。你要找的是"值得的社交"，不是"更多的社交"。两种感受都是真的，不矛盾。'
  },
...
function generateHighlight(patterns, contradictions, customAnswers) {
  ...
  if (patterns.length === 2) {
    return '你在答题中展现了一些你自己可能没注意到的固定模式。两道完全不同的题，你选了同一种策略。这些重复的信号，是你真正的出厂设置。'
  }
